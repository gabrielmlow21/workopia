<header class="bg-blue-900 text-white p-4">
  ...
  >
    <a href="{{url('/jobs')}}" class="block px-4 py-2 hover:bg-blue-700 {{ request()->is('jobs') ? 'text-yellow-400 font-bold' : '' }}">All Jobs</a>
    <a href="{{url('/jobs/saved')}}" class="block px-4 py-2 hover:bg-blue-700 {{ request()->is('jobs/saved') ? 'text-yellow-400 font-bold' : '' }}"
      >Saved Jobs</a
    >
    <a href="{{url('/dashboard')}}" class="block px-4 py-2 hover:bg-blue-700 {{ request()->is('dashboard') ? 'text-yellow-400 font-bold' : '' }}"
      >Dashboard</a
    >
    <a href="{{url('/login')}}" class="block px-4 py-2 hover:bg-blue-700 {{ request()->is('login') ? 'text-yellow-400 font-bold' : '' }}">Login</a>
    <a href="{{url('/register')}}" class="block px-4 py-2 hover:bg-blue-700 {{ request()->is('register') ? 'text-yellow-400 font-bold' : '' }}"
      >Register</a
    >
    <a
      href="{{url('/jobs/create')}}"
